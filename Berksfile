...
cookbook 'endeca', git: "https://github.com/jollyrojer/cookbook-qubell-endeca.git", ref: "0.1.0"
cookbook 'atg', git: "https://github.com/jollyrojer/cookbook-qubell-atg.git", ref: "0.1.0"
